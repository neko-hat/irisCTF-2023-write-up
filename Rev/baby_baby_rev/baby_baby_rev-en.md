...
If v37 is ignored as canary, char-type data is declared from s.

In the stack structure, this is shown in chars[31].
...
In the code above, s[i] == i are passed. Therefore, if you calculate as follows, you will get results.
