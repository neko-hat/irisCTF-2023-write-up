...
Source code, the value of sys.argv[1] in the main function is finally zlib.compressed() and compare with byte data(`b'x\x9c\xcb,\xca,N.I\xab.\xc9\xc8,\x8e7,\x8eOIM3\xcc3,1\xce\xa9\x8c7\x89/\xa8,\xc90\xc8\x8bO\xcc)2L\xcf(\xa9\x05\x00\x83\x0c\x10\xf9’`) Therefore, the byte data in question can be used as a resultant data to apply `zlib.decompress()` The result will be flag.
