...
소스코드, main 함수에서 `sys.argv[1]`의 값을 최종적으로 `zlib.compress()`한 결과값과 바이트 데이터인 `b'x\x9c\xcb,\xca,N.I\xab.\xc9\xc8,\x8e7,\x8eOIM3\xcc3,1\xce\xa9\x8c7\x89/\xa8,\xc90\xc8\x8bO\xcc)2L\xcf(\xa9\x05\x00\x83\x0c\x10\xf9’`과 비교한다. 따라서 해당 바이트 데이터를 `zlib.decompress()`한 결과값이 flag일 것이다.
